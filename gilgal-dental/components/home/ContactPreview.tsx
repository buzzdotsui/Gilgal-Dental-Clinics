    ...
    >
      <div className="container-site">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-0 border-t border-[#E2DFD9]">
          ...
          {/* Address */}
          <div className="py-8 lg:pr-10 border-b lg:border-b-0 lg:border-r border-[#E2DFD9]">
          ...
          {/* Hours */}
          <div className="py-8 lg:px-10 border-b lg:border-b-0 lg:border-r border-[#E2DFD9]">
