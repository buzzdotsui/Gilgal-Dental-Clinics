...
const credentials = [
  {
    icon: GraduationCap,
    label: "Eastman Dental Institute, UK",
  },
  {
    icon: GraduationCap,
    label: "BICON Institute, USA",
  },
  {
    icon: Award,
    label: "Affiliate Member, American Dental Association",
  },
];
      ...
      <div className="container-site">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative rounded-2xl overflow-hidden aspect-[3/4] max-h-[560px] bg-slate-100 shadow-[0_20px_60px_-15px_rgb(1_53_101/0.15)]">
              <Image
          ...
          >
            ...
            {/* Credentials */}
            <ul className="space-y-3 mb-8" role="list" aria-label="Dr. Ugbo's credentials">
